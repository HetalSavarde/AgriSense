...
from app.config import ANTHROPIC_API_KEY, GOOGLE_API_KEY, XAI_API_KEY
...
def call_gemini(image_bytes: bytes) -> dict:
    ...
    model = genai.GenerativeModel("gemini-3.5-flash")  # confirm current model name before demo
